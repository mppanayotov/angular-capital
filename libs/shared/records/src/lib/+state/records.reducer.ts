...
export const recordsAdapter: EntityAdapter<RecordsEntity> = createEntityAdapter<RecordsEntity>();
...
const reducer = createReducer(
  ...
  on(RecordsActions.loadRecordsSuccess, (state, { records }) => recordsAdapter.setAll(records, { ...state, loaded: true })),
