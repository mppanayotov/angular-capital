...
export const selectRecordsState =
  createFeatureSelector<RecordsState>(RECORDS_FEATURE_KEY);
...
export const selectAllRecords = createSelector(
  selectRecordsState,
  (state: RecordsState) => selectAll(state)
);

export const selectRecordsEntities = createSelector(
  selectRecordsState,
  (state: RecordsState) => selectEntities(state)
);
